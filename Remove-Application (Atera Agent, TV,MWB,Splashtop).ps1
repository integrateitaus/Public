#Uninstall Atera Agent, Teamviewer, MalwareBytes and Splashtop for RMM


function Uninstall-Altera {
...
function Uninstall-Malwarebytes {
    ...
    & "C:\Program Files (x86)\Malwarebytes Anti-Malware\unins000.exe" /VERYSILENT /SUPPRESSMSGBOXES /NORESTART
}
